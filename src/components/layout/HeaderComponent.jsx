...
export default function HeaderComponent() {
    ...
    {/* Navbar desktop */}
    <nav className="hidden md:flex text-3xl justify-between items-center max-w-screen-2xl mx-auto p-5 px-2 space-x-10 text-[#a0522d] font-bold">
    ...
    {/* Mobile Menu */}
    <div className={`fixed top-0 left-0 w-full h-full bg-gradient-to-r from-black to-[#3d1f11] from-[10%] to-[90%] backdrop-blur-md text-white flex flex-col items-center justify-center space-y-20 transform ${
