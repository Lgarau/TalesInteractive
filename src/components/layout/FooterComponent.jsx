...
export default function FooterComponent() {
    return (
        <footer className="flex p-10 place-content-around item-center text-white text-start">
            <img className="max-w-50" src={talInt} alt="" />
            <div className="flex  w-full p-10 place-content-between item-center  text-white text-start">
