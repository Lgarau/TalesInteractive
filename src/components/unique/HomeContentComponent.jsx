export default function HomeContentComponent() {
    ...
    return (
        <div className="py-10 px-10 bg-black-100 text-center items-center text-white">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-20 my-30 px-20">
                ...
                <div className="relative p-8 rounded-lg shadow-md text-center">
                    <img src="https://placehold.co/600x400" className="text-[#a0522d] fa-solid fa-user-large rounded-sm mx-auto mb-4 " alt="" />
